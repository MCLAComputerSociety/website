...
class JConfig {
	...
	public $sitename = 'pkelly\'s Site!';				// Name of Joomla site
	...
	public $password = '128dd3095a';						// DB password
	public $db = 'bitnami_joomla';							// DB database name
	public $dbprefix = 'jos_';					// Do not change unless you need to!

	/* Server Settings */
	public $secret = '01aeeae14a99ba8597b32fc10b926a64'; 		// Change this to something more secure
	public $gzip = '0';
